...
OLDPLFOLDER = os.path.join(paths.get_config_dir(), "playlists")
PLFOLDER = os.path.join(paths.get_data_dir(), "playlists")
OLDHISTFILE_1 = os.path.join(paths.get_config_dir(), "play_history")
OLDHISTFILE_2 = os.path.join(paths.get_config_dir(), "play_history.m3u")
HISTFILE = os.path.join(paths.get_data_dir(), "play_history.m3u")
CACHEFILE = os.path.join(paths.get_config_dir(), "cache_py_" + sys.version[0:5])
OLD_READLINE_FILE = os.path.join(paths.get_config_dir(), "input_history")
READLINE_FILE = None
PLAYER_OBJ = None
categories = {
        "film":      1,
